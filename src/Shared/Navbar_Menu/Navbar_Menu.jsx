      ...
      <DialogContent sx={{ p: 0, height: "100%" }}>
        ...
        >
          ...
          {data ? (
            <>
                ...
                >
                  {data.left.map((text, i) => (
                    <Typography
                      key={i}
                      variant="subtitle1"
                      sx={{ color: "red", fontSize: { xs: "0.9rem", sm: "1rem" } }}
                    >
                      {text}
                    </Typography>
                  ))}
              ...
              <Box
                sx={{
                  ...
                  justifyItems: "center",
                  overflowY: "auto",
                  maxHeight: { xs: "calc(90vh - 80px)", sm: "100%", md: "100%" }, // adjust height for mobile scroll
                }}
              >
                {data.right.map((img, i) => (
                  ...
                  >
                    ...
                    <Typography
                      variant="caption"
                      sx={{ mt: 1, fontSize: { xs: "0.7rem", sm: "0.8rem", md: "0.9rem" } }}
                    >
                      {img.name}
                    </Typography>
                  </Box>
            ...
            // Default vertical menu for no data
            <List
              sx={{
                pt: 12,
                display: "flex",
